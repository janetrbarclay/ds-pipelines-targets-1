...
process_data(data_file='model_RMSEs.csv', processed_data_file='model_summary_results.csv')

render_diagnostics(processed_data_file='model_summary_results.csv', diagnostic_output_file = 'model_diagnostic_text.txt')
